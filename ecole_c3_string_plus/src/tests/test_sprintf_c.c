...
START_TEST(sprintf_wide_1) {
  char str1[100];
  char str2[100];
  wchar_t w = L'Ж';  // example wide char
  char* fmt = "%lc Test";
  ck_assert_int_eq(sprintf(str1, fmt, w), my_sprintf(str2, fmt, w));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST

START_TEST(sprintf_wide_2) {
  char str1[100];
  char str2[100];
  wchar_t w1 = L'Ω';
  wchar_t w2 = L'ß';
  char* fmt = "%lc %lc Test";
  ck_assert_int_eq(sprintf(str1, fmt, w1, w2), my_sprintf(str2, fmt, w1, w2));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST

START_TEST(sprintf_wide_3) {
  char str1[100];
  char str2[100];
  wchar_t w1 = L'汉';
  wchar_t w2 = L'字';
  wchar_t w3 = L'😊';
  char* fmt = "%lc %lc %lc Test";
  ck_assert_int_eq(sprintf(str1, fmt, w1, w2, w3),
                   my_sprintf(str2, fmt, w1, w2, w3));
  ck_assert_pstr_eq(str1, str2);
}
END_TEST
...
Suite* test_sprintf_c(void) {
  ...
  tcase_add_test(tc, sprintf_wide_1);
  tcase_add_test(tc, sprintf_wide_2);
  tcase_add_test(tc, sprintf_wide_3);
